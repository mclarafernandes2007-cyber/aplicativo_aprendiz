...
<div style="margin-top:12px">
  ...
  <div style="margin-top:8px;display:flex;gap:8px;align-items:center;flex-wrap:wrap">
    ...
    <button id="btn-enviar" onclick="enviarQuadro()" style="padding:5px 18px;border-radius:6px;
      border:none;background:linear-gradient(135deg,#2e7d32,#43a047);color:#fff;
      cursor:pointer;font-size:0.95rem;font-weight:bold;box-shadow:0 2px 6px rgba(0,200,80,.3)">
      📤 Enviar para todos
    </button>
    <span id="sel-info" style="color:#aaa;font-size:0.82rem">Nenhum emoji selecionado</span>
    <span id="send-feedback" style="color:#4caf50;font-size:0.82rem;display:none">✅ Quadro enviado!</span>
  </div>
</div>"""
